...
{
	local cartart = fe.add_artwork("cartart", flx*0.4, fly*0.65, flw*0.25, flh*0.35 );
...
{
    local cartart = fe.add_image("flyer2/[DisplayName]", flx*0, fly*0, flw*1, flh*1 );
}
...
{
	local boxart = fe.add_artwork("boxart", flx*0, fly*0.55 flw*0.32, flh*0.45 );

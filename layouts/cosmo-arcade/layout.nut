...
class UserConfig {
 	...
 	</ label="Show marquee", help="Show marquee art", options="Yes,No", order=4 /> enable_gmarquee="Yes"; 
 	</ label="Enable lighted marquee effect", help="show lighted Marquee", options="Yes,No", order=5 /> enable_Lmarquee="No";

 	</ label="Show flyers", help="Show flyer art", options="Yes,No", order=6 /> enable_gflyer="Yes";
 	</ label="Artwork aspect ratio", help="Preserve aspect ratio of flyers", options="Yes,No", order=7 /> ratio="Yes";  
 	</ label="Enable animations", help="Enable flyers animations", options="Yes,No", order=8 /> enable_ganimate="Yes"; 
 	
 	</ label="Select pointer", help="Select animated pointer", options="default,emulator,none", order=9 /> enable_pointer="emulator"; 
 	...
 	</ label="Enable random text colors", help=" Select random text colors", options="Yes,No", order=13 /> enable_colors="No";

 	</ label="Enable monitor static effect", help="Show static effect when snap is null", options="Yes,No", order=14 /> enable_static="Yes"; 
	</ label="Mute Videos", help="Mute Videos", options="Yes,No", order=15 /> sound="No"; 
}  
...
//adjust the values below for the static preview video snap
   ...
   local snapbg=null;
   snapbg = fe.add_image( "static.mp4", flx*0.21, fly*0.32, flw*0.30, flh*0.4);
...
surface_snap.set_pos(flx*0.215, fly*0.328, flw*0.29, flh*0.393	);
...
//Marquee
/////////////////////////////////////////////
// Marquee art to display, uses the emulator.cfg path for cartart for cartridge image location
//////////////////////////////////////////////////////////////////////////////////////////////////


if ( my_config["enable_gmarquee"] == "Yes" )
{
	local marquee = fe.add_artwork("marquee", flx*0.169, fly*0.023, flw*0.387, flh*0.165 );
	marquee.skew_y = 0;
	marquee.skew_x = 0;
	marquee.pinch_y = 0;
	marquee.pinch_x = 4;
	...
	{
 		local marquee = fe.add_image("clogos/[DisplayName]", flx*0.169, fly*0.023, flw*0.387, flh*0.165 );
...
{
	local flyer = fe.add_artwork("flyer", flx*0, fly*0.25 flw*0.2, flh*0.6 );
	...
	animation.add( PropertyAnimation( flyer, move_transition1 ) );
	}
}
